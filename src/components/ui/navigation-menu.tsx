...
>(({ className, ...props }: NavigationMenuViewportProps, ref) => (
...
const NavigationMenu = React.forwardRef<
  ...
  NavigationMenuProps
>(({ className, children, ...props }: NavigationMenuProps, ref) => (
...
>(({ className, ...props }: NavigationMenuListProps, ref) => (
...
>(({ className, children, ...props }: NavigationMenuTriggerProps, ref) => (
...
>(({ className, ...props }: NavigationMenuContentProps, ref) => (
...
>(({ className, ...props }: NavigationMenuIndicatorProps, ref) => (
